...
<body>
    ...
    <script>
        ...
        const host = window.location.hostname; // hostname만 가져옴 (포트 제외)
        const port = window.location.port || (protocol === 'wss:' ? '443' : '80'); // 포트가 없으면 기본 포트 사용
        ...
        function connectWebSocket(roomId) {
            ...
            console.log('WebSocket 연결 시도:', wsUrl, '현재 호스트:', host, '포트:', port);
