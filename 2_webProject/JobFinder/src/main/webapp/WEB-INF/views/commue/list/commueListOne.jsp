...
<div class='boxStyle boxListOne'>
	...
	<div id='infoContent'>
		<div>
			<svg xmlns="http://www.w3.org/2000/svg" width="70" height="24" fill="#BABECA" class="bi bi-eye" viewBox="0 0 75 16">
		...
		<div id='commentCount' style="min-width: 100px">
			<svg xmlns="http://www.w3.org/2000/svg" width="100" height="24" fill="#BABECA" class="bi bi-chat-left" viewBox="0 -2 110 16">
		...
		<div>
			<svg xmlns="http://www.w3.org/2000/svg" width="90" height="24" fill="#BABECA" class="bi bi-chat-left" viewBox="0 -2 100 16">
