...
<body>
    ...
    <script>
        ...
        window.memberInfo = '${sessionScope.userLogin}';
        window.memberId = '${sessionScope.userLogin.memberId}';
        window.email = '${sessionScope.userLogin.email}';
    </script>
    <script src="/js/chat/memberChat.js"></script>
</body>
</html> 