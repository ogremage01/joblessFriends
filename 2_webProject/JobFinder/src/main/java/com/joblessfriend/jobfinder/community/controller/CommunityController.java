...
//	@RequestMapping(value="", method = {RequestMethod.GET, RequestMethod.POST})
	...
	// 커뮤니티 업데이트(저장)
	@PostMapping("/update")
	public String communityUpdate(@ModelAttribute CommunityVo communityVo, Model model, HttpSession session) {
		System.out.println("게시판 수정 시작");
	...
	public ResponseEntity<Map<String, Object>> updateImage(@RequestParam("updateFile") MultipartFile file,
			HttpSession session) throws Exception {
		// fileUtils의 uploadFile 메서드 호출
