...
CREATE TABLE RESUME (
    ...
    CONSTRAINT FK_CAREER_TO_RESUME FOREIGN KEY (CAREER_ID) REFERENCES CAREER(CAREER_ID),
    CONSTRAINT FK_EDUCATION_TO_RESUME FOREIGN KEY (EDU_ID) REFERENCES EDUCATION(EDU_ID),
    CONSTRAINT FK_PORTFOLIO_TO_RESUME FOREIGN KEY (PORTFOLIO_ID) REFERENCES PORTFOLIO(PORTFOLIO_ID),
    CONSTRAINT FK_SCHOOL_TO_RESUME FOREIGN KEY (SCHOOL_ID) REFERENCES SCHOOL(SCHOOL_ID)
);
